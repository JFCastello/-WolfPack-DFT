...
#   vasp-test                        # renders ./slurm_vasptest.sh (the exact
#                                    # job), submits it to the debug partition,
#                                    # then advises. Also writes slurm_job.sh
#                                    # (the recommended production job) at the end.
#
